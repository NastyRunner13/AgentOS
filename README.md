...
|---|---|
| [`config/models.yaml`](config/models.yaml) | Provider definitions (OpenRouter, Anthropic, OpenAI, Ollama), API keys, and model mappings for `master`, `fast`, `vision`, and `embeddings` roles. |
